...
const goldenProjectsData = [
  ...
  {
    id: 3,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Coffee Shop",
  ...
  {
    id: 4,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Text to Voice Converter",
  ...
  {
    id: 5,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Devices Store",
  ...
  {
    id: 6,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Freelance Jobs Platform",
  ...
  {
    id: 7,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Ice Cream Shop",
  ...
  {
    id: 8,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Global Food & Drink",
  ...
  {
    id: 9,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "How To Code",
  ...
  {
    id: 10,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Learn English",
  ...
  {
    id: 11,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Learning Path Generator",
  ...
  {
    id: 12,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Learn Math",
  ...
  {
    id: 13,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Template Maker",
  ...
  {
    id: 14,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Notes App",
  ...
  {
    id: 15,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Pizza Shop",
  ...
  {
    id: 16,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Perfume Collection",
  ...
  {
    id: 17,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Random Text Generator",
  ...
  {
    id: 18,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Service Hub",
  ...
  {
    id: 19,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Shoes Store",
  ...
  {
    id: 20,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Desktop Wallpapers",
  ...
  {
    id: 21,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "Watches Store",
  ...
  {
    id: 22,`n    isFree: false,  // ?? LOCKED - Need unlock code`n    title: "LensStory - Camera Evolution",
