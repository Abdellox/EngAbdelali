...
function initializeDefaultData() {
  ...
  if (!hasProjects) {
    const allProjects = [
      ...
      { id: 130, name: 'Context Menu', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/context-menu' },
      { id: 131, name: 'Copy to Clipboard', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/copy-to-clipboard' },
      { id: 132, name: 'Countdown Event', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/countdown-event' },
      { id: 133, name: 'Drag Drop', category: 'ui-components', tech: ['JavaScript', 'Drag API'], folder: 'UI-Components/drag-drop' },
      { id: 130, name: 'Dropdown Menu', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/dropdown-menu' },
      { id: 131, name: 'FAQ Section', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/faq-section' },
      { id: 132, name: 'Infinite Scroll', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/infinite-scroll' },
      { id: 133, name: 'Loading Spinner', category: 'ui-components', tech: ['CSS3', 'HTML5'], folder: 'UI-Components/loading-spinner' },
      { id: 130, name: 'Modal Popup', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/modal-popup' },
      { id: 131, name: 'Pagination', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/pagination' },
      { id: 132, name: 'Pricing Table', category: 'ui-components', tech: ['HTML5', 'CSS3'], folder: 'UI-Components/pricing-table' },
      { id: 133, name: 'Profile Card', category: 'ui-components', tech: ['HTML5', 'CSS3'], folder: 'UI-Components/profile-card' },
      { id: 130, name: 'Progress Bar', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/progress-bar' },
      { id: 131, name: 'Scroll to Top', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/scroll-to-top' },
      { id: 132, name: 'Search Filter', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/search-filter' },
      { id: 133, name: 'Sidebar', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/sidebar' },
      { id: 130, name: 'Skeleton Loader', category: 'ui-components', tech: ['CSS3', 'HTML5'], folder: 'UI-Components/skeleton-loader' },
      { id: 131, name: 'Star Rating', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/star-rating' },
      { id: 132, name: 'Tabs', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/tabs' },
      { id: 133, name: 'Team Members', category: 'ui-components', tech: ['HTML5', 'CSS3'], folder: 'UI-Components/team-members' },
      { id: 130, name: 'Testimonial Slider', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/testimonial-slider' },
      { id: 131, name: 'Theme Switcher', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/theme-switcher' },
      { id: 132, name: 'Toast Notification', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/toast-notification' },
      { id: 133, name: 'Tooltip', category: 'ui-components', tech: ['JavaScript', 'CSS3'], folder: 'UI-Components/tooltip' },
      
      // ENTERTAINMENT (15 projects)
      { id: 158, name: 'Chat App', category: 'entertainment', tech: ['JavaScript', 'CSS3'], folder: 'Entertainment/chat-app' },
      { id: 159, name: 'Chatbot UI', category: 'entertainment', tech: ['JavaScript', 'CSS3'], folder: 'Entertainment/chatbot-ui' },
      { id: 160, name: 'Dictionary App', category: 'entertainment', tech: ['JavaScript', 'API'], folder: 'Entertainment/dictionary-app' },
      { id: 161, name: 'Emoji Picker', category: 'entertainment', tech: ['JavaScript', 'CSS3'], folder: 'Entertainment/emoji-picker' },
      { id: 158, name: 'Joke Generator', category: 'entertainment', tech: ['JavaScript', 'API'], folder: 'Entertainment/joke-generator' },
      { id: 159, name: 'Lorem Generator', category: 'entertainment', tech: ['JavaScript', 'CSS3'], folder: 'Entertainment/lorem-generator' },
      { id: 160, name: 'Lorem Ipsum', category: 'entertainment', tech: ['JavaScript', 'CSS3'], folder: 'Entertainment/lorem-ipsum' },
      { id: 161, name: 'Movie Search', category: 'entertainment', tech: ['JavaScript', 'OMDB API'], folder: 'Entertainment/movie-search' },
      { id: 158, name: 'Music Player', category: 'entertainment', tech: ['JavaScript', 'Audio'], folder: 'Entertainment/music-player' },
      { id: 159, name: 'Random Quote', category: 'entertainment', tech: ['JavaScript', 'API'], folder: 'Entertainment/random-quote' },
      { id: 160, name: 'Random User', category: 'entertainment', tech: ['JavaScript', 'API'], folder: 'Entertainment/random-user' },
      { id: 161, name: 'Recipe App', category: 'entertainment', tech: ['JavaScript', 'API'], folder: 'Entertainment/recipe-app' },
      { id: 158, name: 'Speech to Text', category: 'entertainment', tech: ['JavaScript', 'Web Speech'], folder: 'Entertainment/speech-to-text' },
      { id: 159, name: 'Text to Speech', category: 'entertainment', tech: ['JavaScript', 'Web Speech'], folder: 'Entertainment/text-to-speech' },
      { id: 160, name: 'Video Player', category: 'entertainment', tech: ['JavaScript', 'HTML5 Video'], folder: 'Entertainment/video-player' },
      
      // EDUCATION (5 projects)
      { id: 173, name: 'Math Quiz', category: 'education', tech: ['JavaScript', 'CSS3'], folder: 'Education/math-quiz' },
      { id: 174, name: 'Quiz App', category: 'education', tech: ['JavaScript', 'CSS3'], folder: 'Education/quiz-app' },
      { id: 175, name: 'Speed Typing Test', category: 'education', tech: ['JavaScript', 'CSS3'], folder: 'Education/speed-typing-test' },
      { id: 176, name: 'Typing Speed', category: 'education', tech: ['JavaScript', 'CSS3'], folder: 'Education/typing-speed' },
      { id: 173, name: 'Word Counter', category: 'education', tech: ['JavaScript', 'CSS3'], folder: 'Education/word-counter' }
    ];
    
    localStorage.setItem('portfolioProjects', JSON.stringify(allProjects));
    console.log('✅ All 193 projects loaded!');
  }
