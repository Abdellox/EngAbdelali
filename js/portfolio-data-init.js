...
function initializeDefaultData() {
  ...
  if (!hasProjects) {
    const allProjects = [
      ...
      { id: 7, name: 'Chess Board', category: 'games', tech: ['JavaScript', 'CSS3'], folder: 'Games/chess-board', tier: 'professional' },
      ...
      { id: 12, name: 'Mahjong Game', category: 'games', tech: ['JavaScript', 'CSS3'], folder: 'Games/mahjong-game', tier: 'professional' },
      ...
      { id: 21, name: 'Roulette Game', category: 'games', tech: ['JavaScript', 'Canvas'], folder: 'Games/roulette-game', tier: 'professional' },
      { id: 22, name: 'Simon Game', category: 'games', tech: ['JavaScript', 'CSS3'], folder: 'Games/simon-game' },
      { id: 23, name: 'Slot Machine', category: 'games', tech: ['JavaScript', 'CSS3'], folder: 'Games/slot-machine', tier: 'professional' },
      { id: 24, name: 'Snake Game', category: 'games', tech: ['JavaScript', 'Canvas'], folder: 'Games/snake-game', tier: 'professional' },
      { id: 25, name: 'Solitaire Game', category: 'games', tech: ['JavaScript', 'CSS3'], folder: 'Games/solitaire-game', tier: 'professional' },
      { id: 26, name: 'Space Invaders', category: 'games', tech: ['JavaScript', 'Canvas'], folder: 'Games/space-invaders', tier: 'professional' },
      { id: 27, name: 'Sudoku Solver', category: 'games', tech: ['JavaScript', 'CSS3'], folder: 'Games/sudoku-solver' },
      { id: 28, name: 'Tetris Game', category: 'games', tech: ['JavaScript', 'Canvas'], folder: 'Games/tetris-game', tier: 'professional' },
      ...
      { id: 33, name: 'Wordle Clone', category: 'games', tech: ['JavaScript', 'CSS3'], folder: 'Games/wordle-clone', tier: 'professional' },
      ...
      { id: 44, name: 'Kanban Board', category: 'productivity', tech: ['JavaScript', 'Drag & Drop'], folder: 'Productivity/kanban-board', tier: 'professional' },
      ...
      { id: 51, name: 'Productivity Stats', category: 'productivity', tech: ['JavaScript', 'Charts'], folder: 'Productivity/productivity-stats', tier: 'professional' },
      ...
      { id: 114, name: 'Audio Visualizer', category: 'creative', tech: ['JavaScript', 'Web Audio'], folder: 'Creative/audio-visualizer', tier: 'professional' },
      { id: 115, name: 'Music Player', category: 'creative', tech: ['JavaScript', 'Audio'], folder: 'Creative/music-player', tier: 'professional' },
      ...
      { id: 124, name: 'Expense Tracker', category: 'finance', tech: ['JavaScript', 'Charts'], folder: 'Finance/expense-tracker', tier: 'professional' },
      { id: 125, name: 'Invoice Generator', category: 'finance', tech: ['JavaScript', 'PDF'], folder: 'Finance/invoice-generator', tier: 'professional' },
      { id: 126, name: 'Crypto Tracker', category: 'finance', tech: ['JavaScript', 'API'], folder: 'Finance/crypto-tracker', tier: 'professional' },
      ...
      { id: 162, name: 'Movie Search', category: 'entertainment', tech: ['JavaScript', 'OMDB API'], folder: 'Entertainment/movie-search', tier: 'professional' },
      { id: 163, name: 'Music Player', category: 'entertainment', tech: ['JavaScript', 'Audio'], folder: 'Entertainment/music-player', tier: 'professional' },
      ...
      { id: 169, name: 'Recipe App', category: 'entertainment', tech: ['JavaScript', 'API'], folder: 'Entertainment/recipe-app', tier: 'professional' },
      { id: 170, name: 'Speech to Text', category: 'entertainment', tech: ['JavaScript', 'Web Speech'], folder: 'Entertainment/speech-to-text', tier: 'professional' },
      { id: 171, name: 'Text to Speech', category: 'entertainment', tech: ['JavaScript', 'Web Speech'], folder: 'Entertainment/text-to-speech', tier: 'professional' },
